...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-lg font-semibold font-sans transition-colors focus-visible:outline-3 focus-visible:outline-focus focus-visible:outline-offset-2 disabled:pointer-events-none disabled:opacity-50 whitespace-nowrap min-h-11 px-3.5 py-2.5 text-sm leading-none cursor-pointer",
  {
    variants: {
      variant: {
      ...
      size: {
        sm: "text-xs min-h-11 px-2.5 py-1.5",
        md: "text-sm min-h-11 px-3.5 py-2.5",
